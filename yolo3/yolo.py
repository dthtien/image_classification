...
class YOLO(object):
    ...
    _DEFAULT_PARAMS = {
        "weights_path": os.path.join(update_path('model_data'), 'tiny-yolo_weights_final.h5'),
        "anchors_path": os.path.join(update_path('model_data'), 'tiny-yolo_anchors.csv'),
        "classes_path": os.path.join(update_path('model_data'), 'train_classes.txt'),
        "score": 0.3,
        "iou": 0.45,
    ...
    def __init__(self, weights_path, anchors_path, classes_path, model_image_size=(416, 416),
